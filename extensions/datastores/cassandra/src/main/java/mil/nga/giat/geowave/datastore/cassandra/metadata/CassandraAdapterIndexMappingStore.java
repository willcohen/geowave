 ...
 * constraints.
 */
public class CassandraAdapterIndexMappingStore extends
		AbstractCassandraPersistence<AdapterToIndexMapping> implements
		AdapterIndexMappingStore
{
	protected static final String ADAPTER_INDEX_CF = "AIM";

	public CassandraAdapterIndexMappingStore(
