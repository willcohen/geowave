		...
		AbstractGeoWaveIT
{
	...
	public void testInsert()
		...
		if (dataStore.getType().equalsIgnoreCase(
				"hbase")) {
			final HBaseOperations ops = createOperations();
	...
	private HBaseOperations createOperations()
			throws IOException {
		if (dataStore.getFactoryOptions() instanceof HBaseRequiredOptions) {
			...
			return HBaseOperations.createOperations(opts);
		}
		...
		// return BigTableOperations.createOperations(
		// opts);
		// }
		return null;
	}
